...
# Function to retrieve the latest trade for a given symbol from Alpaca.Markets
def get_latest_trade(symbol: str) -> dict:
    """
    Function to retrieve the latest trade for a given symbol from Alpaca.Markets
    :param symbol: The symbol to retrieve the latest trade for
    """

    # Set the API endpoint
    url = f"https://data.alpaca.markets/v2/stocks/{symbol}/trades/latest?feed=sip"
